...
public class Skud_Decode_code_letterCombination {
	...
	public static void main(String[] args) {
		...
		while (tc-- > 0) {
			...
			// System.out.println(new M().letterCombination1(ip));

			List<String> lprint = new M().letterCombination1(ip);
			for (String i : lprint)
				System.out.print(i + " ");
...
class M {
	...
	public static List<String> letterCombination1(String digits) {
